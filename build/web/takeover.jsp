...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <title>.:IdeaBroker:. - Take Over</title>
      ...
      <%
            ...
            if(username.compareTo("root")==0)
            {
                ...
                {                    
                    ...
                    ideabrokerbean.takeover(id_topico,id_ideia);
                       
      %>
      <h3 align="center">IdeaBroker - TakeOver </h3>
      <hr>        
    ...
    <div class="container marketing">  
    	<fieldset align="center">
         ...
         <table border="0" align="center" summary="Lista de Utilizadores">
                <tr>
                    <td colspan="2"><h4>Sucesso na Operação!<br><br></td> 
                </tr>
        ...
        <%
            ...
            {
                out.println("Você não é administrador! Que está tentando fazer? :)");
            }
