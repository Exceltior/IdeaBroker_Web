...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <title>.:IdeaBroker:. - Portifólio</title>
            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"> <a href="portofolio.jsp">Portofolio</a> </li>
  ...
  <div class="container">
      <%
            ...
            resposta=ideabrokerbean.portifolio(username);
         %>
      <h4 align="center">Portifolio:</h4>
      <hr>
    	...
    	<table id="newspaper-a" align="center" summary="Lista de Utilizadores">
            <thead>
                <tr>
                    ...
                    <th scope="col">Percentagem Obtida:</th>
                </tr>
            </thead>
            <tbody>
                <%
