	...
	public static void main(String args[]) {
        ...
        while(true)
        {
        	...
        	try{
                ...
                //System.out.println("Contador1  == " + contador + "Socket "+ServidoresTCP[contador/3]+": "+Portas1[contador/3]+"\n");
                // System.out.println("Contador == " + contador);
        	input_output = new Socket(ServidoresTCP[contador/3],Portas1[contador/3]);
                dadosServidor = new Scanner(input_output.getInputStream());
                
                //System.out.println("Contador2  == " + contador + "Socket "+ServidoresTCP[contador/3]+": "+Portas2[contador/3]+"\n");
                estado_servidor = -1;
                MenuPrincipal thread = new MenuPrincipal();
                thread.setNewSocket(new Socket(ServidoresTCP[contador/3], Portas2[contador/3]));
                
                thread.iniciar();
                //System.out.println("Teste01\n");
                
                ip_actual = ServidoresTCP[contador/3];
                estado_servidor = 1;
                    ...
                    try{
                            ...
                            if(informacao.contentEquals("qwerty"))
                            {
                                ...
                                if(utilizador_notificacao.contentEquals(thread.getUtilizadologado()))
                                {
                                    ...
                                    thread.acidionar_notificacao(tipo+"\n");
...
class MenuPrincipal extends Thread
{
    ...
    **/
    ...
    public void bolsa(int id_topico)
    {
        ...
        while(percentagemuser<1 || percentagemuser>100)
        {
        ...
        System.out.println("Introduza quantos DEICoins está disposto a investir na percentagem dada:");
        investimento=inputMensagem.nextInt();
        output.println(investimento);
        System.out.println("Qual o preço a que deseja vender as novas acções?");
        novopreco=inputMensagem.nextInt();
        output.println(novopreco);
        String texto="";
        String aux;
      /*    while(true)
          {
...
/** <------------ Thread que trata dos comandos offline ---------------> **/
